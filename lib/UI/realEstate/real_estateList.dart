...
class RealEstateList extends StatefulWidget {
  ...
  final int? index;
  const RealEstateList({super.key, required this.data,required this.index});
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(child: Text(widget.data[index].tital ??"",style: const TextStyle(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(widget.data[index].locationh??"",style: const TextStyle(
                          fontSize: 11,
...
class CommercialPGList extends StatefulWidget {
  final List<commercialPGDetail> data;
  final String? type;
  const CommercialPGList({super.key, required this.data,this.type});

  @override
  State<CommercialPGList> createState() => _CommercialPGListState();
}

class _CommercialPGListState extends State<CommercialPGList> {
  late RealEstateBloc bloc;
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            onTap: () {
              ...
              // Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Provider.value(value: bloc,child: CommercialDetail(id: "${widget.data[index].id}" ),)));
            },
            child: Container(
              width: 1.sw,
              margin: EdgeInsets.only(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Expanded(child: Text(widget.data[index].title ??"",style: const TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 13
                        ),)),
                        const SizedBox(width: 10,),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(widget.data[index].location??"",style: const TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.w400,
                        ),),
                      ],
