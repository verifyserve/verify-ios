...
class View_Details_Realestate extends StatefulWidget {
  final String iidd;
  const View_Details_Realestate({Key? key, required this.iidd}) : super(key: key);

  @override
  State<View_Details_Realestate> createState() => _View_Details_RealestateState();
}

class _View_Details_RealestateState extends State<View_Details_Realestate> {

  Future<List<DocumentMainModel>> fetchCarouselData() async {
    final response = await http.get(Uri.parse("https://verifyserve.social/WebService4.asmx/Show_Image_under_Realestatet?id_num=${widget.iidd}"));
  ...
  Future<List<Catid>> fetchData() async {
    var url = Uri.parse("https://verifyserve.social/WebService4.asmx/Show_proprty_realstate_by_originalid?PVR_id=${widget.iidd}");
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    width: 180,
                                                    child: Text(""+abc.data![len].Verify_price+"  "+abc.data![len].Rent,
                                                      overflow: TextOverflow.ellipsis,
                                                      maxLines: 2,
                                                      style: TextStyle(
                                                          fontSize: 14,
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    width: 180,
                                                    child: Text(""+abc.data![len].maintence,
                                                      overflow: TextOverflow.ellipsis,
                                                      maxLines: 2,
                                                      style: TextStyle(
                                                          fontSize: 14,
