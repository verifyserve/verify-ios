...
class PGDetail extends StatefulWidget {
  final String id;
  PGDetail({super.key, required this.id});

  @override
  State<PGDetail> createState() => PGDetailState();
}

class PGDetailState extends State<PGDetail>
  ...
  Future<void> fetchdata(iid,number,propertyid,amount,bidprice) async{
    final responce = await http.get(Uri.parse('https://verifyserve.social/WebService1.asmx/AddRealstateBuyer?buyer_id=$iid&buyer_number=$number&property_id=$propertyid&property_title=PG_RealEstate&property_amount=$amount&make_an_offer=$bidprice'));
                            ...
                            return Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: (){
                                  ...
                                  fetchdata(iidd,num, bloc.PGDetailData.first.id, bloc.PGDetailData.first.price, _Bidprice.text);
                  ...
                  children: [
                    Stack(
                      children: [
                        CachedNetworkImage(
                          imageUrl:
                          "http://www.verifyserve.social/upload/${bloc.PGDetailData.first.img}",
                          width: 1.sw,
                          height: 0.3.sh,
                          fit: BoxFit.fill,
                        ...
                        /*Image.network(
                          "http://www.verifyserve.social/upload/${bloc.PGDetailData.first.imagesh}",
                          width: 1.sw,
                          height: 0.3.sh,
                          fit: BoxFit.fill,
                        ),*/
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${bloc.PGDetailData.first.location} ${bloc.PGDetailData.first.filterlocation}" ??
                                    "",
                          ...
                          Text(
                            bloc.PGDetailData.first.shortdis ?? "",
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            bloc.PGDetailData.first.furnished ?? "",
                                            style:
                                            TextStyle(color: Colors.white),
                                          )
                                        ],
                              ...
                              children: [
                                SingleChildScrollView(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      bloc.PGDetailData.first.specification ?? "",
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  ),
                                ),
                                SingleChildScrollView(
                                  child: Padding(
                                    padding: const EdgeInsets.only(right: 10.0,left: 10,top: 10,bottom: 10),
                                    child: Text(
                                      bloc.PGDetailData.first.details ?? "",
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  ),
                                ),
