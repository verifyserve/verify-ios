...
class Residentiall_filter extends StatefulWidget {
  const Residentiall_filter({super.key});

  @override
  State<Residentiall_filter> createState() => _Residentiall_filterState();
}

class _Residentiall_filterState extends State<Residentiall_filter> {
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Show_CommonFilter(Buy_Rent: "${rent[buyIndex.value]}", Typeofproperty: "${timing[timingIndex.value]}", Place_: "${_place.toString()}", Bhk_Squarefit: "${bhk[bhkIndex.value]}",)));
...
class Show_CommonFilter extends StatefulWidget {
  final String Buy_Rent;
  final String Typeofproperty;
  final String Place_;
  final String Bhk_Squarefit;
  const Show_CommonFilter({Key? key, required this.Buy_Rent, required this.Bhk_Squarefit, required this.Place_, required this.Typeofproperty}) : super(key: key);

  @override
  State<Show_CommonFilter> createState() => _Show_CommonFilterState();
}
          ...
          children: [
            Container(
              child: FutureBuilder<List<Catid>>(
                  future: fetchData(widget.Buy_Rent.toString(), widget.Bhk_Squarefit.toString(), widget.Place_.toString(), widget.Typeofproperty.toString()),
                  builder: (context,abc){
