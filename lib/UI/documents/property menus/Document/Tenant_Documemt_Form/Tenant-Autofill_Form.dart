...
import '../ApplyDocument_byTenant.dart';
...
class Tenant_AutoFill_Form extends StatefulWidget {
  String id;
  Tenant_AutoFill_Form({super.key, required this.id});

  @override
  State<Tenant_AutoFill_Form> createState() => _Tenant_AutoFill_FormState();
}

class _Tenant_AutoFill_FormState extends State<Tenant_AutoFill_Form> {
  ...
  Future<List<Catid_Tenant>> fetchData_Owner() async{
        ...
        children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //SizedBox(width: 10,),
                    Text(""+_TenantName/*+abc.data![len].Building_Name.toUpperCase()*/,
                      style: TextStyle(
                          fontSize: 14,
                          color: Colors.white,
                  ...
                  showDialog<bool>(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            FlutterPhoneDirectCaller.callNumber('${_TenantNumber}');
                          },
                          child: Text('Yes'),
                        ),
                      ],
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      // Icon(Iconsax.sort_copy,size: 15,),
                      //SizedBox(width: 10,),
                      Text(""+_TenantNumber/*+abc.data![len].Building_Name.toUpperCase()*/,
                        style: TextStyle(
                            fontSize: 14,
                            color: Colors.white,
                            fontWeight: FontWeight.w500,
          ...
          GestureDetector(
            onTap: () async {
              ...
              print(_OwnerNumber);
              final responce = await http.get(Uri.parse("https://verifyserve.social/WebService4.asmx/show_store_count_document?number=${_OwnerNumber.toString()}"));
              ...
              if (responce.body == '[{"logg":1}]') {
                ...
                // Failed login
                fetchData();
                final result_Tenant = await fetchData();
                //Insurt_Document(_OwnerName, _OwnerNumber, _TenantName, _TenantNumber, "floor_number_tanant", "flat_number_tanant", "rent_amount_tanat", "owner_fathername", "tanant_fathername", "owner_occupation", "tanant_occupation", "owner_dateofbirth", "tanant_dateofbirth", "owner_permanant_address", "tanant_permanant_address", "owner_district", "tanant_district", "owner_permanant_address_police_station", "tanant_permanant_address_police_station", "owner_permanant_address_pincode", "tanant_permanant_address_pincode", "owner_place", "tanant_place", "tananted_address", "tananted_address_district", "tananted_address_police_station", "tananted_address_pincode", "tananted_place", "current_date_", "Owner id", " ", tempArray.toString(), "Processing");
                if (tempArray.toString() == "[Police Verification, Rent Agreement]")
