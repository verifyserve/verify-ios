...
class View_Details_Tenant extends StatefulWidget {
  final String iidd;
  final String SUbid;
  final String T_num;
  final String O_Num;
  const View_Details_Tenant({Key? key, required this.iidd, required this.SUbid, required this.T_num, required this.O_Num}) : super(key: key);

  @override
  State<View_Details_Tenant> createState() => _View_Details_TenantState();
}

class _View_Details_TenantState extends State<View_Details_Tenant> {
                            ...
                            return ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => ApplyDocument_Tenant()));
